...
dynamic class skyui.Config
{
	...
	static private var _constantTable:Object = {
		...
		NAME: COL_TYPE_NAME,
		TEXT: COL_TYPE_TEXT,
		CAT_FAVORITES: Defines.FLAG_ITEM_FAVORITES,
		CAT_ALL: Defines.FLAG_ITEM_ALL,
		CAT_WEAPONS: Defines.FLAG_ITEM_WEAPONS,
		CAT_ARMOR: Defines.FLAG_ITEM_ARMOR,
		CAT_POTIONS: Defines.FLAG_ITEM_POTIONS,
		CAT_SCROLLS: Defines.FLAG_ITEM_SCROLLS,
		CAT_FOOD: Defines.FLAG_ITEM_FOOD,
		CAT_INGREDIENTS: Defines.FLAG_ITEM_INGREDIENTS,
		CAT_BOOKS: Defines.FLAG_ITEM_BOOKS,
		CAT_KEYS: Defines.FLAG_ITEM_KEYS,
		CAT_MISC: Defines.FLAG_ITEM_MISC,
