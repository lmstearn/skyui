...
class ItemMenu extends MovieClip
{
	...
	function InitExtensions(a_bPlayBladeSound)
	{
		...
		if (skseWarning != undefined) {
			...
			} else if (_global.skse.version.major < SKSE_REQ_VERSION.major || (_global.skse.version.major == SKSE_REQ_VERSION.major && _global.skse.version.minor < SKSE_REQ_VERSION.minor) || (_global.skse.version.major == SKSE_REQ_VERSION.major && _global.skse.version.minor == SKSE_REQ_VERSION.minor && _global.skse.version.beta < SKSE_REQ_VERSION.beta)) {
				skseWarning._visible = true;
	...
	*/
	...
	function RestoreIndices()
	{
		...
		InventoryLists_mc.initMenu = true;
		...
		InventoryLists_mc.initMenu = false;
